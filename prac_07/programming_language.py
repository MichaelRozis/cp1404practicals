...
ProgrammingLanguage class with name, typing, reflection, year, and pointer arithmetic.
"""
...
class ProgrammingLanguage:
    ...
    def __str__(self):
        ...
        return f"{self.name}, {self.typing} Typing, Reflection={self.reflection}, "f"Pointer Arithmetic={self.pointer_arithmetic}, First appeared in {self.year}"
